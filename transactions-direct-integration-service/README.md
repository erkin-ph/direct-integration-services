...
- `java -jar target/transactions-service-1.0.0-SNAPSHOT.war`
...
[http://localhost:8080/gateway/api/transactions-direct-integration-service/v2/transactions?arrangementId=AJUZ764](http://localhost:8080/gateway/api/transactions-direct-integration-service/v2/transactions?arrangementId=AJUZ764)